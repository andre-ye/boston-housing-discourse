...
export const beat = {
  ...
  title: 'The data',
  bodyHtml: [
    '<p>Two sources sit on the sphere together.</p>',
    '<h3>Reddit, 2015&ndash;2025</h3>',
    '<p>About 400,000 posts and comments from Boston-region subreddits ',
    '&mdash; r/boston, r/Massachusetts, r/cambridgema, r/somerville, and the ',
    'neighbourhood subs around them &mdash; filtered for housing, transit, ',
    'and city life. Pulled from the public Reddit dump on ',
    '<a href="https://academictorrents.com" target="_blank" rel="noopener">Academic Torrents</a>, ',
    'not scraped live.</p>',
    '<h3>Street interviews</h3>',
    '<p>About eighteen people interviewed in person around Boston, at MBTA ',
    'stops and on sidewalks, about housing, transit, and what the city is ',
    'like to live in. They appear on the sphere as <span class="opener-pin">P</span>-pins, ',
    'placed near the Reddit threads they sit closest to in meaning.</p>',
    '<h3>What is not here</h3>',
    '<p>People who don&rsquo;t post on Reddit. Anyone we didn&rsquo;t reach ',
    'on the street &mdash; people without phones, people not out walking ',
    'when we were. This is not a representative sample of Boston. It is ',
    'two specific kinds of voice, side by side.</p>',
  ].join(''),
  enter(ctx) {
    const { globe } = ctx;
