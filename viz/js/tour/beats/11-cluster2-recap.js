...
export const beat = {
  ...
  bodyHtml:
    ...
    '(15%). Within “MA Tenant Rights &amp; Law,” the largest of five ' +
    'stances was Lease Terms &amp; Tenant Rights at 42% — disputes over ' +
    ...
    'Together they read almost like a legal forum: retaliation evictions, ' +
    'deposit fights, masslegalhelp.org links — different vocabulary from ' +
    'the rent-control argument, but with similar stakes.</p>' +
